...
export const services: ServiceDetail[] = [
  ...
  {
    slug: 'tabling-programs',
    title: 'Tabling Programs',
    icon: '🪑',
    shortDescription: 'Setup booths and tables at high-traffic campus locations for direct brand engagement with students',
    description: 'Setup booths and tables at high-traffic campus locations for direct brand engagement with students. Our tabling programs position your brand where students naturally gather — dining halls, student unions, quad areas, and campus walkways — creating face-to-face interactions that drive awareness, trial, and conversion. Every tabling activation is staffed by trained student ambassadors who know how to engage their peers authentically.',
    features: [
      'Strategic location selection at highest-traffic campus zones',
      'Branded table setup with eye-catching displays and signage',
      'Interactive demos and hands-on product experiences',
      'Lead capture with digital sign-up and opt-in tools',
      'Data collection and consumer insights reporting',
      'Multi-campus coordination for scaled tabling tours',
    ],
    cta: 'Launch a Tabling Program',
  },
  {
    slug: 'dorm-storm-campaigns',
    title: 'Dorm Storm Campaigns',
    icon: '🚪',
    shortDescription: 'Door-to-door residential hall outreach that puts your brand directly in students\' hands',
    description: 'Door-to-door residential hall outreach that puts your brand directly in students\' hands. Dorm storms are one of the most personal and high-impact forms of college marketing — our trained teams go room-to-room delivering samples, flyers, and branded materials directly to students where they live. Combined with digital follow-up, dorm storm campaigns create lasting impressions and measurable engagement.',
    features: [
      'Residence hall access coordination with housing offices',
      'Door hanger campaigns with branded messaging and offers',
      'Hallway activations in common areas and lounges',
      'RA partnerships for endorsed distribution and programming',
      'Room-to-room product distribution and sampling',
      'Digital follow-up integration with QR codes and landing pages',
    ],
    cta: 'Storm the Dorms',
  },
  {
    slug: 'poster-and-bulletin-board-campaigns',
    title: 'Poster & Bulletin Board Campaigns',
    icon: '📌',
    shortDescription: 'Strategic placement of branded posters and flyers across campus bulletin boards, dorms, and common areas',
    description: 'Strategic placement of branded posters and flyers across campus bulletin boards, dorms, and common areas. Poster campaigns remain one of the most cost-effective ways to build brand visibility on college campuses, reaching students repeatedly as they move through their daily routines. Our team handles everything from design support to placement logistics and verification, ensuring your message stays visible all semester long.',
    features: [
      'Campus-approved posting locations and compliance management',
      'Eye-catching poster design support and creative consultation',
      'Regular placement and replacement to maintain visibility',
      'Tear-off tab integration for trackable student response',
      'QR code tracking for digital engagement measurement',
      'Coverage verification photos and placement reporting',
    ],
    cta: 'Start a Poster Campaign',
  },
  {
    slug: 'digital-screen-advertising',
    title: 'Digital Screen Advertising',
    icon: '📺',
    shortDescription: 'Advertise on campus digital screens in student centers, dining halls, libraries, and residence halls',
    description: 'Advertise on campus digital screens in student centers, dining halls, libraries, and residence halls. Digital screen advertising reaches students in the spaces they spend the most time — waiting for food, studying between classes, and relaxing in common areas. With dynamic content scheduling and campus-wide screen networks, your brand message is delivered at scale with unskippable, high-frequency impressions.',
    features: [
      'Campus TV network placement across multiple venues',
      'Digital signage content creation and motion graphics',
      'Dining hall screen ads reaching students during meals',
      'Library and study space display placements',
      'Athletic venue screens for game day visibility',
      'Real-time content scheduling and daypart targeting',
    ],
    cta: 'Advertise on Campus Screens',
  },
  {
    slug: 'campus-radio-and-podcast-sponsorship',
    title: 'Campus Radio & Podcast Sponsorship',
    icon: '🎙️',
    shortDescription: 'Sponsor college radio stations and student podcasts to reach engaged campus audiences through audio',
    description: 'Sponsor college radio stations and student podcasts to reach engaged campus audiences through audio. College radio and student-run podcasts command loyal, attentive listenership that traditional digital ads struggle to match. Our sponsorship programs connect your brand with authentic student voices, delivering your message through trusted campus media channels that students actively choose to tune into.',
    features: [
      'Radio spot production tailored to college audiences',
      'Podcast ad integration with host-read endorsements',
      'Student DJ partnerships for organic brand mentions',
      'Live remote broadcasts from campus events and activations',
      'Contest and giveaway integration to drive engagement',
      'Listener engagement tracking and campaign analytics',
    ],
    cta: 'Sponsor Campus Audio',
  },
]
